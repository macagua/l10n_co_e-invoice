...
class AccountTax(models.Model):
    ...
    tax_group_fe = fields.Selection([
        ('iva_fe','IVA FE'), ('ica_fe','ICA FE'), ('ico_fe','INC FE'),
        ('ret_fe','RET FE'), ('nap_fe','No aplica a DIAN FE')
        ], string="Grupo de impuesto DIAN FE", default='nap_fe'
    )
    tributes = fields.Selection([
        ('01','IVA'), ('02','IC'), ('03','ICA'), ('04','INC'), ('05','ReteIVA'), ('06','ReteFuente'),
        ...
        ('ZY','No causa'), ('ZZ','Nombre de la figura tributaria')
        ], string="Tributo DIAN"
    )
